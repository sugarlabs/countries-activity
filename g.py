# g.py - globals
import pygame,utils,random,ctry
...
def init(): # called by run()
    ...
    if pygame.font:
        t=int(30*imgf); font0=pygame.font.Font(None,t)
    ...
    xy0=(sx(0),sy(0))
    globe=utils.load_image('globe.png',True); xyc=(sx(16),sy(9))
    pages=False; countries=None; map1=False
